...
public sealed partial class AdvancedSettingsWindow : Window
{
    ...
    public EnvironmentUpdate Update => new(
        ...
        new Db2PhysicsOptions(
            ...
            (float)(SurfaceGravity.Value ?? 2),
            (float)(StaticFriction.Value ?? 0.6m),
            (float)(KineticFriction.Value ?? 0.4m),
            (double)(Density.Value ?? 0),
            (double)(Viscosity.Value ?? 0),
            (float)(Elasticity.Value ?? 0m)),
        new Db2ShotOptions(
            (float)(ShotSpeed.Value ?? 40),
            (float)(ShotRangeMultiplier.Value ?? 1),
            (float)(ShotDecay.Value ?? 40),
        ...
        new Db2VegetationOptions(
            ...
            (int)(MaxPlantEnergy.Value ?? 40),
            (int)(MinimumChloroplastEquivalents.Value ?? 10),
            (int)(RepopulationAmount.Value ?? 10),
            (ulong)(RepopulationCooldown.Value ?? 25),
            (float)(FeedingToBody.Value ?? 0.5m),
